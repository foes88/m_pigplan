...
import 'package:m_pigplan/model/login_model.dart';
              ...
              children: <Widget>[
                ...
                MaterialButton(
                  ...
                  onPressed: () async {
                    ...
                    var url = 'http://192.168.4.141:8080/pigplan/into/lgin/loginchecked.do' + parameters;
 ...
 Future<String> restApiGetXml(url, parameters) async {
  ...
  if(jsonDecode(jsonString)['Map']['okcode'] != null) {
    ...
    if (statusCode == 200) {
      ...
      //정규식으로 SESSION 값 추출
      var sessionValue = sessionRegex.stringMatch(response.headers['set-cookie'].toString().trim());
